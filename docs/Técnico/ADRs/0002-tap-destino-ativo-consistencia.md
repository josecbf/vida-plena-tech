...
**Status:** Proposto — aguardando decisão do dono. (GPT e Claude convergem que o **caminho de escrita** do destino ativo está sub-especificado e é o coração do módulo crítico.)
