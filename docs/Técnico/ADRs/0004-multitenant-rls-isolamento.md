...
2b. **Manter políticas RLS simples** — Gemini alerta que políticas com JOINs complexos (ex.: checar hierarquia de liderança consultando Pessoas) degradam a performance sob carga concorrente. Resolver autorização complexa em camada de aplicação/contrato, não dentro da policy.
