...
| ADR | Título | Status |
|---|---|---|
| [0001](0001-plataforma-inicial-e-escala.md) | Plataforma inicial e caminho de escala | Aceito (com 1 ponto aberto) |
| [0002](0002-tap-destino-ativo-consistencia.md) | Consistência do destino ativo do TAP | **Proposto** |
...
| [0005](0005-identidade-plugavel-revisao.md) | Identidade plugável — revisão pós-Gemini | **Proposto** |
