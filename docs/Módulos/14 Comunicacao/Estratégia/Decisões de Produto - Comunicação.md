...
# Decisões de Produto - Comunicação
...
- Capacidades v1 priorizadas: Segmentos, Campanhas, Templates, Canais.
- Integrações prioritárias: Pessoas, Eventos, Ensino, GCs.
- Métricas iniciais: Envios entregues, Falhas por canal, Preferências atualizadas.
