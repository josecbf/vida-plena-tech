...
# Decisões de Produto - Grupos de Crescimento
...
- Capacidades v1 priorizadas: Cadastro de grupos, Participantes, Liderança, Reuniões.
- Integrações prioritárias: Pessoas, SOM, Ensino, Eventos.
- Métricas iniciais: Frequência média, Pessoas sem grupo, Grupos sem reunião recente.
